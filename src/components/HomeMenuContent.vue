<template>
  <div
    class="relative flex-none px-6 overflow-hidden lg:pointer-events-none lg:fixed lg:inset-0 lg:z-40 lg:flex lg:px-0"
  >
    <div
    ...
    >
      <div
        class="max-w-lg mx-auto lg:mx-0 lg:flex lg:w-96 lg:max-w-none lg:flex-col lg:before:flex-1 lg:before:pt-6"
      >
        <div class="pt-20 pb-16 sm:pb-20 sm:pt-32 lg:py-20">
          <div class="relative">
            <div class="max-w-xs mx-auto">
              <img src="../image/logo/mendoka_logo.png" alt="Mendoka Logo" />
            </div>
            <h1
            ...
            <p
              class="mx-auto mt-4 text-sm text-gray-300 text-center max-w-xs sm:max-w-sm px-3"
            >
              Single developer who strives to turn every pixel into an
            ...
            >
              <div class="block space-y-3 sm:space-y-0 sm:flex">
                <div
                  class="hover:cursor-pointer flex-none group relative isolate flex items-center rounded-lg px-2 py-0.5 text-sm font-medium text-white/30 transition-colors hover:text-sky-300 gap-x-3"
                >
                  <span
                  ...
                  <span class="self-baseline text-white">Events</span>
                </div>
                <div
                  class="hover:cursor-pointer flex-none group relative isolate flex items-center rounded-lg px-2 py-0.5 text-sm font-medium text-white/30 transition-colors hover:text-sky-300 gap-x-3"
                >
                  ...
                  <span class="self-baseline text-white">Games</span>
                </div>
              </div>
            ...
            <div
              class="flex items-end justify-center flex-1 pt-3 pb-4 lg:justify-center lg:pb-6"
            >
              <p class="flex items-baseline gap-x-2 text-sm text-gray-500">
                Support me on
                <a
                  class="group relative isolate flex items-center rounded-lg px-2 py-0.5 text-sm font-medium text-white/30 transition-colors hover:text-sky-300 gap-x-2"
                ...
                >
                  ...
                  <span class="self-baseline text-white">Kofi</span>
                </a>
              </p>
            </div>
          </div>
        ...
        <div
          class="flex items-end justify-center flex-1 pb-4 lg:justify-center lg:pb-6 mt-[-50px] sm:mt-0"
        >
          <p class="flex items-baseline gap-x-2 text-sm text-gray-500">
            <a
              class="group relative isolate flex items-center rounded-lg px-2 py-0.5 text-sm font-medium text-white/30 transition-colors hover:text-sky-300 gap-x-2"
