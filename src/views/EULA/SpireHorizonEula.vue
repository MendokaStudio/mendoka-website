<template>
    <div class="flex flex-col space-y-10 m-20">
      ...
      <div class="law-text-paragraph">
        Spire Horizon is licensed to You (End-User) by Mendoka, located and
      ...
      <div class="law-text-paragraph">
        Spire Horizon, when purchased or downloaded through the Services,
      ...
      <div class="law-text-paragraph">
        Spire Horizon ("Licensed Application") is a piece of software
